...
{
  public class AddUserToRoleCommand : RoleModificationDTO, IRequest<int>
  {

    public class Handler : IRequestHandler<AddUserToRoleCommand, int>
    {
      ...
      public async Task<int> Handle(AddUserToRoleCommand request, CancellationToken cancellationToken)
      {
        String Errors="";
        try
        {
